...
# Custom Button class with rounded corner effect
...
dataentery_frame_bg = '#00ccff'
buttons_frame_bg = '#00008b'
hlb_btn_bg = '#add8e6'
...
# Buttons' Frame
# Create an instance of the custom RoundedButton class
delete_expense_btn = RoundedButton(buttons_frame, text='Delete Expense', command=remove_expense)
delete_expense_btn.place(x=30, y=5)

clear_fields_btn = RoundedButton(buttons_frame, text='Clear Fields in DataEntry Frame', command=clear_fields)
clear_fields_btn.place(x=335, y=5)

delete_all_expenses_btn = RoundedButton(buttons_frame, text='Delete All Expenses', command=remove_all_expenses)
delete_all_expenses_btn.place(x=640, y=5)

view_expense_details_btn = RoundedButton(buttons_frame, text="View Selected Expense's Details", command=view_expense_details)
view_expense_details_btn.place(x=30, y=65)

edit_expense_btn = RoundedButton(buttons_frame, text='Edit Selected Expense', command=edit_expense)
edit_expense_btn.place(x=335, y=65)

selected_expense_to_words_btn = RoundedButton(buttons_frame, text='Convert Expense to a sentence', command=selected_expense_to_words)
selected_expense_to_words_btn.place(x=640, y=65)
# Treeview Frame
